...
/// 由入口（Program / GameServerHost）构建一次后映射为各模块的配置切片注入
/// （<see cref="DungeonChessBattle.Server.Lobby.LobbyServerConfig"/>、<see cref="DungeonChessBattle.Server.Battle.BattleServerConfig"/>）。
/// </summary>
