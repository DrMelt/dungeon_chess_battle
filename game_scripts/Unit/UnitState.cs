...
namespace DungeonChessBattle.Core {
    ...
    public partial class UnitState : Resource, IUnitState {
        ...
        [Export]
        Array<UnitSkillBase> _skillsList;
        public Array<UnitSkillBase> SkillsList => _skillsList;
        ...
        public UnitSkillBase SpellingSkill => spellingSkill;

        public void SpellNewSkill(UnitSkillBase unitSkillBase) {
            spellingSkill?.SpellBroked();

            spellingSkill = unitSkillBase;
            CallSpellingSkill();
        }
        ...
        public void AddBuff(BuffBase buff) {
            ...
            if (find != null) {
                ...
                buffList.Add(buff);
                OnBuffAddedEvent?.Invoke(this, buff);
            }
        }
