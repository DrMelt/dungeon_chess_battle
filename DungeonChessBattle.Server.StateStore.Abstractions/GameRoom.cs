...
public class GameRoom(string roomId) {
    ...
    /// <remarks>战斗单位状态由战斗编排 BattleEngine 面向 IBattleUnit 的 Pawn 实体权威持有，不再挂载于房间模型。</remarks>
