...
/// <summary>单位受到伤害。SourceUnitId 为伤害来源，UnitId.None 表示无来源不记仇。</summary>
public readonly record struct DamageOccurred(UnitId SourceUnitId, UnitId TargetUnitId, float AppliedDamage, DamageType DamageType) : IBattleEvent;

/// <summary>单位接受治疗。SourceUnitId 为治疗来源，UnitId.None 表示无来源不记仇。</summary>
public readonly record struct HealOccurred(UnitId SourceUnitId, UnitId TargetUnitId, float ActualHeal) : IBattleEvent;
...
public readonly record struct CastStarted(UnitId CasterUnitId, SkillKeyId SkillId, UnitId? TargetUnitId) : IBattleEvent;

/// <summary>施法读条被主动取消，含移动打断。</summary>
public readonly record struct CastCanceled(UnitId CasterUnitId, SkillKeyId SkillId) : IBattleEvent;
