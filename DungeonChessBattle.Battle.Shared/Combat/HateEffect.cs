...
/// <summary>
/// 仇恨修改效果：HolderUnitId 的仇恨表中对 SourceUnitId 的仇恨执行 Op 操作。
/// 由仇恨技能结算产出，直接作用于单位仇恨表。
/// </summary>
public readonly record struct HateEffect(UnitId HolderUnitId, UnitId SourceUnitId, HateEffectOp Op, float Value);

/// <summary>仇恨快照投影单元，同步用。</summary>
public readonly record struct HateSnapshot(UnitId TargetUnitId, float Value);
